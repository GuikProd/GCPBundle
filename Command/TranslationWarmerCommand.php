...
use GuikProd\GCPBundle\Command\TranslationWarmerCommandInterface;
...
class TranslationWarmerCommand extends Command implements TranslationWarmerCommandInterface
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($files as $file) {
            ...
            foreach ($content as $key => $translation) {
                ...
                foreach ($acceptedLocales as $locale) {
                    ...
                    $translatedElements[$locale][$key] = $this->cloudTranslationWarmer->warmTranslation($translation, $locale)['text'];
        ...
        foreach ($translatedElements as $element) {
            foreach ($acceptedLocales as $locale) {
                foreach ($defaultFilename as $filename => $file) {
                    dump(strtr($file, ['fr' => 'toto']));
                }
